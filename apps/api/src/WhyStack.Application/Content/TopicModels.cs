...
/// </summary>
/// <remarks>
/// CLAUDE.md §1.7 and `08` Principle 07 both forbid a silent fallback. This object is why: when a Turkish
/// reader opens a topic that has not been translated, they are shown the English text — and they are TOLD.
///
/// The alternative is an app that quietly serves English to somebody who set their content language to
/// Turkish. They would conclude the translation is bad, or that the setting does not work. Neither is
/// true, and neither is something they can report, because nothing on the screen says what happened.
/// </remarks>
...
/// </summary>
/// <remarks>
/// Prerequisites, related topics and the next topic are NOT sections of the Markdown — they are edges.
/// The client renders them as sections; the database stores them once, as relationships. This is the one
/// shape in which they are allowed to reach a screen.
/// </remarks>
